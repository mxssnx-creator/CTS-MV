...
export function SystemTab({ settings, handleSettingChange }: SystemTabProps) {
  return (
    <div className="space-y-6">
      {/* Main System Configuration Tabs */}
      <Tabs defaultValue="system" className="space-y-4">
        <TabsList className="grid grid-cols-3 w-full bg-muted/50 p-1">
          <TabsTrigger value="system">System Config</TabsTrigger>
          <TabsTrigger value="trading">Trading Engine</TabsTrigger>
        ...
        <TabsContent value="system" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Core system settings and database management</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4 border-t pt-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">Time between main engine execution cycles</p>
                </div>
        ...
        <TabsContent value="data" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure data handling and cleanup policies</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
